...
#计算PPI网络中的sab值和dab值
def graphFromPPI():
    filepath_PPI = 'D:/R/sab/'
    filename_PPI = 'PPI_symbol_noego.txt'
    G = nx.Graph()
...
filepathgene = 'D:\\R\\sab\\gene'
filepathtar = 'D:\\R\\sab\\tar'

filegene1 = 'gene76.txt'
filegene2 = 'gene89.txt'
filegene3 = 'gene157.txt'
filegene4 = 'gene270.txt'
filegene5 = 'gene313.txt'
filegene6 = 'gene390.txt'
filegene7 = 'gene412.txt'
filegene8 = 'gene441.txt'
filegene9 = 'gene0.txt'

filegene101 = 'geneNaproxen.txt'
filegene102 = 'gene403.txt'
filegene103 = 'gene404.txt'
filegene104 = 'gene405.txt'
filegene105 = 'gene406.txt'
filegene106 = 'gene407.txt'
filegene107 = 'gene408.txt'
filegene108 = 'gene409.txt'
filegene109 = 'gene410.txt'
filegene110 = 'gene411.txt'
filegene111 = 'gene412.txt'
filegene112 = 'gene413.txt'
filegene113 = 'gene414.txt'
filegene114 = 'gene415.txt'
filegene115 = 'gene416.txt'
filegene116 = 'gene417.txt'
filegene117 = 'gene418.txt'
filegene118 = 'gene419.txt'
filegene119 = 'gene420.txt'
filegene120 = 'gene421.txt'
filegene121 = 'gene422.txt'
filegene122 = 'gene423.txt'
filegene123 = 'gene424.txt'
filegene124 = 'gene425.txt'
filegene125 = 'gene426.txt'
filegene126 = 'gene427.txt'
filegene127 = 'gene428.txt'
filegene128 = 'gene429.txt'
filegene129 = 'gene430.txt'
filegene130 = 'gene431.txt'
filegene131 = 'gene432.txt'
filegene132 = 'gene433.txt'
filegene133 = 'gene434.txt'
filegene134 = 'gene435.txt'
filegene135 = 'gene436.txt'
filegene136 = 'gene437.txt'
filegene137 = 'gene438.txt'
filegene138 = 'gene439.txt'
filegene139 = 'gene440.txt'
filegene140 = 'gene441.txt'
filegene141 = 'gene442.txt'
filegene142 = 'gene443.txt'
filegene143 = 'gene444.txt'
filegene144 = 'gene445.txt'
filegene145 = 'gene446.txt'
filegene146 = 'gene447.txt'
filegene147 = 'gene448.txt'
filegene148 = 'gene449.txt'
filegene149 = 'gene450.txt'
filegene151 = 'gene0.txt'
targets = 'targets1.txt'
genefilelist = []
tarfilelist = []
...
for i in range(0,len(genefilelist)-1):
    for j in range(i+1,len(genefilelist)):
        ...
        with open('sab11.csv','a') as f:
            f.write(str(genefilelist[i]))
            f.write('\t')
            f.write(str(genefilelist[j]))
            f.write('\t')
            f.write(str(S_ab - (Sa + Sb) / 2.0))
            f.write('\n')
